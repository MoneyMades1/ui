...
function Library:ToggleMenu()
    -- Assuming you have a method to hide/show your menu
    if self.menuVisible then
        self:Hide()  -- Hide the menu
    else
        self:Open()  -- Show the menu
    end
    self.menuVisible = not self.menuVisible  -- Toggle visibility state
end
local library = {
    Flags = {},
